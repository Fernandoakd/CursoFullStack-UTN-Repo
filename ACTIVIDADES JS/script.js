...
const strings = ["Hola","Pedro","Como","Estas"]
console.log(`Resultado: ${concatString(strings)}`);
------------------------------------------------*/
...
const listaNumeros = [4,7,8,11,33,2,50]
console.log(`Resultado: ${numerosMayoresA10(listaNumeros)}`);
-----------------------------------*/
...
const listaNumeros = [4,7,8,11,33,2,50]
console.log(`Resultado: ${sumaPares(listaNumeros)}`);
-----------------------------------*/
/*5)
...
-----------------------------------
const eliminarString = (strings, stringEliminar) => {

  if (stringEliminar && isNaN(stringEliminar)) {

    let posicion = strings.indexOf(stringEliminar)
    if (posicion !== -1) {
...
console.log(`Resultado: ${eliminarString(palabras,"como")}`);
-----------------------------------*/
...
const nombres = ["fernando","aldo","dante"]
let resultado = crearLista(nombres,"futbol")
-----------------------------------*/
/*7)
...
-----------------------------------
const cantidadAparacion = (strings, stringBuscado) => {
  return strings.filter(x => stringBuscado === x).length
}

const palabras = ["¿","hola","como","estas","?","estas","bien","como","estas","como"]
console.log(`Resultado: ${cantidadAparacion(palabras,"bien  ")}`);
-----------------------------------*/
/*8)
...
const vender = (cantidadVendida,precio,nombreDeProducto) => {
  if (!cantidadVendida && isNaN(cantidadVendida) && cantidadVendida < 0) {
    
  return "El valor de la cantidad vendida no es válido"
}else if (!precio && isNaN(precio) && precio < 0) {
  
return "El valor del precio no es válido"
} else if(!nombreDeProducto && !isNaN(nombreDeProducto)) {
  
return "El nombre del producto ingresado no es un valor válido"
}

const object = {
  nombreProducto : nombreDeProducto,
  totalVendido : cantidadVendida*precio
}

gananciasMensuales.push(object)
}

console.log(`Totales: ${JSON.stringify(gananciasMensuales)}`);
vender(3,400.00,"Jabón")
console.log(`Totales: ${JSON.stringify(gananciasMensuales)}`);
vender(6,100.00,"Papel")
console.log(`Totales: ${JSON.stringify(gananciasMensuales)}`);
/*-----------------------------------*/
...
const comprar = (cantidadComprada,precio,nombre) => {
  let resultado = 0
  resultado = cantidadComprada * precio
  const gasto = {
    gasto: nombre,
    total: resultado
  }
  gastosMensuales.push(gasto)
}
comprar(3,100,"azucar")
comprar(8,200,"pan")
comprar(1,200,"sal")
console.log(`Resultado: ${JSON.stringify(gastosMensuales)}`);
/*-----------------------------------*/
